          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Surat Keluar / Detail</span></h3>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <form class="forms-sample">
                          ...
                          <h2 class="mt-4">Catatan Koreksi</h2>
                          <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th><b>Catatan Koreksi</b></th>
                                    <th><b>Korektor</b></th>
                                    <th><b>Waktu</b></th>
                                </tr>
                            </thead>
                          ...
                          <div class="form-group">
                            <div class="mt-4">
                                <a class="btn btn-light" href="surat-keluar.php">Kembali</a>
                            </div>
                        </form>
                      </div>
                    </div>
