          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Pengaturan Surat / Jenis Surat / Tambah Label</span></h3>
            </div>
            <div class="row">
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample mt-4">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="type" id="jenis-surat" placeholder="Jenis Surat">
                                </div>
                              </div>
                              <div class="col-md-8">
                                <div class="form-group">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <a class="btn btn-light" href="setting-jenis-surat.php">Cancel</a>
                            </div>
                        </form>
                      </div>
                    </div>
